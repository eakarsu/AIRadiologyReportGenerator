...
const FEATURE_SLUG = 'no-protocolcomplianceaudit-acrinstitutional';
const FEATURE_TITLE = 'No /protocol-compliance-audit (ACR/institutional standards)';
const PROJECT = 'AIRadiologyReportGenerator';
